...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**𓆩𓆩︙ اهـلا حـب {mention} 𓆪𓆪**\n**𓆩𓆩︙ {my_mention}'انا البـوت المسـاعـد .𓆪𓆪**\n**𓆩𓆩︙ يمـكـنك الـتواصـل مـع صـاحب الـبوت فـقط ارسـل رسـالتك 𖠄.**\n**𓆩𓆩︙ الـبوت خـاص بسورس :𓆪𓆪** [فيـنوم](https://t.me/botate56)"
        buttons = [
            (
                Button.url("الـمـطـور فـيـنوم", "https://t.me/M_2_F"),
                Button.url(
                    "الـمـطـور سـتايون",
                    "https://t.me/alw_sh313",
                ),
            )
        ]
    else:
        start_msg = "**𓆩𓆩:اهلا بك ايها المطور 𓆪𓆪**\n**𓆩𓆩︙لروئيه الاوامر الخاصه فيك أرسل 𓆪𓆪** : `/مساعدة`"
        buttons = None
    try:
