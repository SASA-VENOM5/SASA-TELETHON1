...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/a0d61c571ae7e018c0535.mp4", caption="♛ ⦙ تـمّ اعـادة تشـغيل\n سورس كوبرا ✓  :  [ 7.5 ] .\n\n♛ ⦙ للحصول على اوامر السورس\n أرسـل : (  `.اوامري`  ) \n\n♛ ⦙ لمـعرفة كيفية تغير بعض كلايش\n او صور السـورس  أرسـل  :\n (  `.مساعده`  )\n\n♛ ⦙ القناة الرسمية سورس كوبرا : @VFF35",                buttons=[(Button.url("مطور السورس", "https://t.me/QABNADLIB"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "مجموعه بوت كوبرا الخاص بك", iqthon, Config.TG_BOT_USERNAME, descript        )
