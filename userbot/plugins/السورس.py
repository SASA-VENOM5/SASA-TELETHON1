...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/54c23911b9300713734bd.jpg"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/9fabee1e4ce0ee6f98484.jpg"
...
async def iq(iqthonevent):
    ...
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/a0d61c571ae7e018c0535.mp4"
...
async def source(e):
    await edit_or_reply(e, "https://github.com/SASA-VENOM5/SASA-TELETHON",)
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ **𓆩𓆩سورس فينوم- Telethon-Venom ، 🕸 𓆪𓆪** ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"☭︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس فينوم @M_2_F 𖠄 @alw_sh313 :**\n\n{o}")
...
async def _(event):
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "**𖠄︙   تم تحديث سورس فينوم ↻**")
    sandy = await edit_or_reply(event , "**𓆩𓆩𖠄︙جـاري تـحديـث سورس فينوم 𓆪𓆪**\n**𓆩𓆩🔹 - قـد يستغـرق الأمـر 5 - 10 دقائـق انتـظـر 𓆪𓆪**\n**𓆩𓆩لاتقـم بتحـديث أكثـر من 3 مـرات باليـوم 𓆪𓆪**" ,)
    try:
...
**𓆩𓆩المطور : @M_2_F 𓆪𓆪**
**𓆩𓆩المطور : @alw_sh313 𓆪𓆪**
**𓆩𓆩قناة السورس : @S_Q_I 𓆪𓆪**
**𓆩𓆩قناة السورس : @botate56 𓆪𓆪**""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**𖠄︙يرجى متابع قناه السورس تجدها هنا : @botate56")
    ...
    if exe == "get":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(                    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬  - 𝐕𝐄𝐍𝐎𝐌 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                    f"\n **⌔** `{variable} = {heroku_var[variable]}` .\n"                )
            return await ics.edit(                "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 - 𝐕𝐄𝐍𝐎𝐌 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                f"\n **⌔ خطا :**\n-> {variable} غيـر موجود. "            )
        except IndexError:
        ...
        if variable in heroku_var:
            await ics.edit("**⌔ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت فينوم يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- قناة السورس", "https://t.me/botate56"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/SASA-VENOM5/SASA-TELETHON"),],[Button.url("الـمـطـور", "https://t.me/M_2_F"),],[Button.url("الـمطـور", "https://t.me/alw_sh313"),]]
...
async def iq(event):
    await edit_or_reply(event, """✐  ⦗ اوامـر سـورس فينوم ⦘
                                             ┉┉┉┉┉┉×┉┉┉┉┉
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**𖠄︙ قـائمـه الاوامـر :**\n**☭︙ قنـاه السـورس :** @S_Q_I\n**𖠄︙ شـرح اوامـر السـورس : @botate56**\n**𖠄︙ شـرح فـارات السـورس : @botate56** "
