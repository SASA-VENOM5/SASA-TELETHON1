    ...
    try:
        async with bot.conversation(chat) as conv:
            try:
                ...
                await iqthon.edit("**𓆩𓆩 قم بفك الحظر من البوت : @office2pdf_bot 𓆪𓆪**")
                return
        ...
        return await iqthon.edit("**𓆩𓆩 هناك خطا نعتذر 𓆪𓆪**") 
@iqthon.on(admin_cmd(pattern="بوتي$"))
async def iq(iqbot):
    TG_BOT_USERNAME = Config.TG_BOT_USERNAME
    await iqbot.reply(f"**𓆩𓆩 بوت تليثون الخاص بك : {TG_BOT_USERNAME} 𓆪𓆪**")
@iqthon.on(admin_cmd(pattern="ملصقي ?(.*)"))
async def iq(iqthon):
    if iqthon.fwd_from:
        return
    if not iqthon.reply_to_msg_id:
        await edit_delete(iqthon, "**𓆩𓆩 الرجاء الرد على الرسالة 𓆪𓆪**")
        return
    reply_message = await iqthon.get_reply_message()
    ...
    async with bot.conversation(chat) as conv:
        try:
            ...
            await iqthon.reply("**𓆩𓆩 قم بفك الحظر من البوت : @QuotLyBot 𓆪𓆪**")
            return
        if response.text.startswith("Hi!"):
            await edit_or_reply(
                iqthon, "**𓆩𓆩 الرجاء تعطيل إعادة توجيه إعدادات الخصوصية الخاصة بك 𓆪𓆪**")
        else:
            await iqthon.delete()
...
async def iq(iqthon):
    if not iqthon.reply_to_msg_id:
        return await iqthon.edit("**𓆩𓆩 الرجاء الرد على الرسالة 𓆪𓆪**")
    reply_message = await iqthon.get_reply_message()
    chat = "@auddbot"
    try:
        async with iqthon.client.conversation(chat) as conv:
            try:
                await iqthon.edit("**𓆩𓆩 التعرف على الأغاني...𓆪𓆪**")
                ...
                await iqthon.edit("**𓆩𓆩 انتظر لحظة...𓆪𓆪**")
                result = await conv.get_response()
                await iqthon.client.send_read_acknowledge(conv.chat_id)
            except YouBlockedUserError:
                await iqthon.edit("**قم بفك الحظر من البوت : @auddbot :𓆪𓆪**")
                return
...
async def _(iqthon):
    chat = "@TempMailBot"
    geez = await iqthon.edit("**𓆩𓆩 جاري انشاء بريد ...𓆪𓆪**")
    async with bot.conversation(chat) as conv:
        try:
            ...
            await geez.edit("**𓆩𓆩 قم بفتح الحظر عن : @TempMailBot للأستمرار بانشاء البريدات 𓆪𓆪**")
            return
...
async def _(iqthon):  # sourcery no-metrics
    ...
    if not input_str and not reply_message:
        await edit_delete(iqthon, "**𖠄 ⦙ قم بالـرد على رسالـة لمستخـدم للحصـول على إسمـه/سجل يوزراتـه أو قم بإعطـاء آيـدي المستخـدم/يـوزر المستخـدم ✦**")
    user, rank = await get_user_from_event(iqthon, secondgroup=True)
    if not user:
        return
    uid = user.id
    chat = "@SangMataInfo_bot"
    iqevent = await edit_or_reply(iqthon, "**𓆩𓆩𖠄 ⦙ جـاري المعالجـة ↯𓆪𓆪**")
    async with iqthon.client.conversation(chat) as conv:
        try:
            await conv.send_message(f"/search_id {uid}")
        except YouBlockedUserError:
            await edit_delete(iqthon, "**𓆩𓆩𖠄 ⦙ قم بإلغـاء حظـر @Sangmatainfo_bot ثم حـاول !!𓆪𓆪**")
        responses = []
        while True:
            try:
        ...
        await iqthon.client.send_read_acknowledge(conv.chat_id)
    if not responses:
        await edit_delete(iqthon, "**𓆩𓆩𖠄 ⦙ لا يستطيـع البـوت جلـب النتائـج 𓆪𓆪**")
    if "No records found" in responses:
        await edit_delete(iqthon, "**𓆩𓆩𖠄 ⦙ المستخـدم ليـس لديـه أيّ سجـل ✕𓆪𓆪**")
...
async def _(iqthon):
    ...
    if not reply_message:
        await edit_or_reply(iqthon, "**𓆩𓆩𖠄 ⦙  الرد على الرابط.𓆪𓆪**")
        return
    if not reply_message.text:
        await edit_or_reply(iqthon, "**𓆩𓆩𖠄 ⦙  الرد على الرابط.𓆪𓆪**")
        return
    chat = "@fs0bot"
    iqevent = await edit_or_reply(iqthon, "**𓆩𓆩𖠄 ⦙  جاري تحميل الرابط 𓆪𓆪**")
    async with iqthon.client.conversation(chat) as conv:
        try:
            ...
            await iqevent.edit("**𓆩𓆩𖠄 ⦙  فك الحظر من البوت : @fs0bot 𓆪𓆪**")
            return
...
async def _(event):
    ...
    chat = "@i0zbot"
    catevent = await edit_or_reply(event, "**𓆩𓆩 جـارِ الزغـرفـه 💝🐾...𓆪𓆪**")
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit("**𓆩𓆩 تحـقق من انـك لم تقـم بحظر البوت @i0zbot .. ثم اعـد استخدام الامـر ... 𓆪𓆪️**")
            return
        if response.text.startswith("**𓆩𓆩 رجاء قم بالرد على الكلمه التي تريد زخرفتها 𓆪𓆪"):
            await catevent.edit("𓆩𓆩 رجاء قم بالرد على الكلمه التي تريد زخرفتها 𓆪𓆪")
        else:
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit("**𓆩𓆩 تحـقق من انـك لم تقـم بحظر البوت @zagtelethonbot .. ثم اعـد استخدام الامـر ... 𓆪𓆪️**")
            return
        if response.text.startswith("**𓆩𓆩 رجاء قم بالرد على الكلمه التي تريد زخرفتها 𓆪𓆪**"):
            await catevent.edit("**𓆩𓆩 رجاء قم بالرد على الكلمه التي تريد زخرفتها 𓆪𓆪**")
        else:
...
async def iq(iqthoninsta):
    ...
    if "www.instagram.com" not in link:
        await edit_or_reply(iqthoninsta, "**𓆩𓆩 يجب كتابة رابط 𓆪𓆪**")
    else:
        start = datetime.now()
        iqevent = await edit_or_reply(iqthoninsta, "**𓆩𓆩 جار التحميل 𓆪𓆪**")
    async with iqthoninsta.client.conversation(chat) as knov:
        try:
            ...
            await iqevent.edit("**𓆩𓆩 بفتح الحظر  @instasavegrambot 𓆪𓆪**")
            return
        await iqevent.delete()
...
async def _IQ(iqthon):
    ...
    if not iqthon.reply_to_msg_id:
        return await edit_or_reply(iqthon, "**𓆩𓆩 الرد على أي رسالة مستخدم.𓆪𓆪**")
    reply_message = await iqthon.get_reply_message()
    if not reply_message.media:
        return await edit_or_reply(iqthon, "**𓆩𓆩 الرد على الملف 𓆪𓆪**")
    chat = "@VS_Robot"
    IQevent = await edit_or_reply(iqthon, "**𓆩𓆩 انتضر قليل 𓆪𓆪**")
    async with iqthon.client.conversation(chat) as conv:
        try:
            await conv.send_message("/start")
            await conv.get_response()
            ...
            return await IQevent.edit("𓆩𓆩 قم بفتح الحظر من : @VS_Robot 𓆪𓆪")
        if not input_str:
...
async def _iq(iqthon):
    ...
    if len(input_sgra) != 2:
        return await edit_delete(iqthon, "**𓆩𓆩 تصحيح قم بكتابه الأمر هكذا : **`.تقويم السنه الشهر ` 𓆪𓆪", 5)
