...
def _stop():
    ...
    _LOG.info(_LOG_STR, f" تم تنصـيـب جـمــيع مكاتـب سورس فـيـنوم : {_EXECUTOR._max_workers} ")


# pylint: disable=protected-access
_LOG.info(_LOG_STR, f" تم تنصيب جميع مكاتب سورس كوبرا : {_EXECUTOR._max_workers} ")
